        ...
        return (
                <nav>
                    <ul>
                        ...
                        <li className="social"><img src={ require('../../images/art_nav_social.gif') } width={217} height={28} useMap="#default" className="social" /></li>
                    </ul>
                    <map name="default" id="default">
                        <area coords="0,0,61,30" href="http://www.youtube.com/user/FlaudLogic" alt="YouTube Channel" title="YouTube Channel" />
                        <area coords="66,0,94,28" href="http://news.flaudlogic.com/feeds/posts/default?alt=rss" target="_blank" alt="RSS" title="RSS" />
