...
const MEMBERS = [
  ...
  },
  {
    ...
    "role": "Saxophone",
    "bio":
      "<p>Composer, keyboardist, saxophonist, engineer and producer- founding member of Happy The Man, Frank Wyatt has worn many hats. From his Crafty Hands Studio he continues to produce innovative and fresh new music, most recently the Pedal Giant Animals project, and now new band Oblivion Sun's debut.</p>",
      ...
      <Layout pageClass="about-page">
        ...
        <ExpandText>
          <section>
            <blockquote>
              <p>
                "...really grabbing — like a black hole that just sucked me in
                from the get-go."
              </p>
              <small>
                — Chris Rich, Composer, Theater of the Mind Rock Opera
              </small>
            </blockquote>
            <p>
              Flaud Logic originated in Brooklyn, New York in 2008. Originally
              an attempt to demo some song ideas composer Michael Kaplan had
              written over the years, it gradually evolved into a full-length
              album featuring performances from a cadre of talented musicians
              including Michael Romeo (guitar), Frank Wyatt (saxophone), Joe
              Bergamini (drums), and Benny Lackner (Rhodes).
            </p>
            <span>
              <p>
                Over a period of months, Michael composed and arranged these
                musical ideas into what would become the album's core: Four
                tracks—one, a 23-minute epic—that take the listener through a
                variety of soundscapes and stories.
              </p>
              <p>
                The Flaud Logic sound can best be described as progressive rock,
                a genre true to Michael's love of sonic experimentation. The
                album spans a range of styles and moods—from elation to
                sorrow—painted by careful instrumentation and vivid lyrics.
                Moments of bone-crushing metal, the clockwork intricacy of
                mathcore, and retro Beatles-era rock, meet soaring and uplifting
                passages and catchy hooks.
              </p>
            </span>
          </section>
        </ExpandText>
